...
const game_history_schema_1 = require("./schemas/game-history.schema");
let AuditoriesService = class AuditoriesService {
    constructor(historyModel) {
        this.historyModel = historyModel;
    }
    recordGameHistory(gameHistory) {
        const record = new this.historyModel(Object.assign({ date: Date.now() }, gameHistory));
        return record.save();
    }
};
